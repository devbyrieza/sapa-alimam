...
export default function RadarTamuAdmin() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      {ratingMode && (
        <div role="dialog" aria-modal="true" data-modal="true" className="fixed inset-0 z-50 bg-slate-900/80 backdrop-blur-md flex items-center justify-center p-4 overscroll-contain">
